...
var validator = {
  ...
  reintializeValidation: function(form, scope, module) {
    ...
    form
      .find(
        'textarea,select,input:not(input[type="hidden"],input[type="submit"],input[type="file"],input[data-ignore-validation])'
      )
      .each(function() {
        $(this).on("blur", function() {
          ...
          var initValidator = function() {
            ...
            if (scope.hasOwnProperty("errors")) {
              if (module && module.trim().length > 0) {
                scope.errors[module] = validator.getFormattedErrorMessage(
                  errors,
                  scope.errors.hasOwnProperty(module)
                    ? scope.errors[module]
                    : {},
                  element
                );
              } else {
                scope.errors = validator.getFormattedErrorMessage(
                  errors,
                  scope.errors,
                  element
                );
  ...
  validateReactForm: function(form, module) {
    ...
    $(form)
      .find(
        'textarea,select,input:not(input[type="submit"],input[type="file"],input[data-ignore-validation],input[data-unique])'
      )
      .each(function() {
        ...
        if (module) {
          Object.assign(
            validator.component.state.inputErrors[module],
            validator.getFormattedErrorMessage(
              validationErrors,
              validator.component.state.inputErrors[module],
              this
            )
    ...
    validator.component.setState({
      inputErrors: validator.component.state.inputErrors
    });
  ...
  fillMultiCheckErrorMessageUsingJquery: function(
    element,
    errors,
    elementName
  ) {
  ...
  reintializeEventValidationByModule: function(module, scope) {
    if (
      this.forms.hasOwnProperty(module) &&
      typeof this.forms[module] === "object"
    ) {
      this.forms[module]
        .find(
          'textarea,select,input:not(input[type="hidden"],input[data-datepicker],input[type="submit"],input[type="file"],input[data-ignore-validation])'
        )
        .each(function() {
          $(this).on("blur", function() {
            ...
            if (scope.hasOwnProperty("errors")) {
              scope.errors[module] = validator.getFormattedErrorMessage(
                errors,
                scope.errors.hasOwnProperty(module) ? scope.errors[module] : {},
                this
              );
